...
class _$LoginResponseModelImpl implements _LoginResponseModel {
  const _$LoginResponseModelImpl({required this.data});
...
abstract class _LoginResponseModel implements LoginResponseModel {
  const factory _LoginResponseModel({required final LoginData data}) =
...
abstract class $LoginDataCopyWith<$Res> {
  ...
  $Res call(
      {String token,
      @JsonKey(name: 'two_factor') bool isTwoFactorEnabled,
      UserModel user});
...
class _$LoginDataImpl implements _LoginData {
  const _$LoginDataImpl(
      {required this.token,
      @JsonKey(name: 'two_factor') required this.isTwoFactorEnabled,
      required this.user});
  ...
  @override
  String toString() {
    return 'LoginData(token: $token, isTwoFactorEnabled: $isTwoFactorEnabled, user: $user)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, token, isTwoFactorEnabled, user);
...
abstract class _LoginData implements LoginData {
  const factory _LoginData(
      ...
      @JsonKey(name: 'two_factor') required final bool isTwoFactorEnabled,
      required final UserModel user}) = _$LoginDataImpl;
